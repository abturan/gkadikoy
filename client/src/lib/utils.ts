...
export const CATEGORY_COLORS: Record<string, { bg: string; text: string; border: string }> = {
  ...
  saglik: { bg: "bg-[var(--kadikoy-blue)]", text: "text-white", border: "border-[var(--kadikoy-blue)]" },
...
export const CATEGORY_LIGHT_COLORS: Record<string, { bg: string; text: string }> = {
  ...
  saglik: {
    bg: "bg-[var(--kadikoy-blue-soft)] dark:bg-[var(--kadikoy-blue-soft-dark)]",
    text: "text-[var(--kadikoy-blue)] dark:text-[var(--kadikoy-blue)]",
  },
